...
col_info = orders.dtypes.to_frame(name='Data Type').reset_index()
missing_values = orders.isnull().sum().to_frame(name='Missing Values').reset_index()
data_summary = pd.merge(col_info, missing_values, on='index')

print(f"Row Count: {row_count}")
print("\nData Summary:")
print(data_summary)

# Check for duplicates or unique IDs
...
Data Summary:
            index       Data Type  Missing Values
0          Row ID           int64               0
1        Order ID          object               0
2      Order Date  datetime64[ns]               0
3       Ship Date  datetime64[ns]               0
4       Ship Mode          object               0
5     Customer ID          object               0
6   Customer Name          object               0
7         Segment          object               0
8         Country          object               0
9            City          object               0
10          State          object               0
11    Postal Code           int64               0
12         Region          object               0
13     Product ID          object               0
14       Category          object               0
15   Sub-Category          object               0
16   Product Name          object               0
17          Sales         float64               0
18       Quantity           int64               0
19       Discount         float64               0
20         Profit         float64               0
